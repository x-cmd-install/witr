...
[![x-cmd/install — witr Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/witr.svg?lang=zh)](https://x-cmd.com/install/witr)
...
- **官网**: <https://pranshuparmar.github.io/witr/>
- **许可证**: Apache-2.0
...
- **Star**: 22,482 · **Fork**: 786 · **开放 issue**: 88 · **贡献者**: 36

## 累计统计

- **发布数**: 21 · **已合并 PR**: 113 · **开放 PR**: 8 · **已关闭 issue**: 78 · **开放 issue**: 10 · **提交数**: 588

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 0 | 0 | 3 | 0 | 4 | 0 |
| last60d | 2026-07-26 | 0 | 3 | 7 | 1 | 9 | 3 |
| 90d | 2026-06-26 | 0 | 7 | 8 | 3 | 9 | 34 |
| last180d | 2026-03-28 | 2 | 14 | 8 | 15 | 10 | 108 |
| 360d | 2025-09-29 | 21 | 113 | 8 | 78 | 10 | 398 |
| last720d | 2024-10-04 | 21 | 113 | 8 | 78 | 10 | 588 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/witr.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:44:46Z._
